...
Unduh QR Code
@endcomponent -->
<a href="{{ asset('singgasana-sport/public/qr_codes/' . $data->qr) }}" download="{{ $data->qr }}" style="background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
    Unduh QR Code
</a>
