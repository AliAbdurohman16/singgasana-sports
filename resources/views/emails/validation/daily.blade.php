...
<div class="row mb-2"><div class="col-12"><img src="{{ $data->qr }}" alt="QR Code" class="img-fluid" style="display:block;margin:auto;margin-bottom:20px;text-align:center;width:100px;"></div></div>
