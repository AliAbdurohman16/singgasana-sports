...
<div class="row mb-2"><div class="col-12"><img src="{{ asset('qr_codes/' . $data->qr) }}" style="display:block;margin:auto;margin-bottom:20px;text-align:center;width:100px;"alt="QR Code"></div></div>
