                        ...
                        <table class="table categories-table" id="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->service->name }}</td>
                                    <td>{{ $row->category }}</td>
                                    <td>Rp {{ number_format($row->one_hours, 0, ',', '.') }}</td>
                                    <td>
                                    <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/squash/member/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
