...
@section('title', 'Edit Data Swimming Pool Sekolah')
          ...
          <div class="col-lg-6">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('swimmingPoolSchool.update', $school->id) }}" method="POST" class="form" data-parsley-validate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="school" value="{{ old('school', $school->category) }}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="first-name-column">Harga</label>
                                        <input type="text" class="form-control" id="price" name="price" value="{{ old('price', intval($school->price)) }}"/>
                                    </div>
                                </div>
