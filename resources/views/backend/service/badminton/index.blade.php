                        ...
                        <table class="table categories-table" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/badminton/daily/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <table class="table categories-table" id="table2">
                            <thead>
                                <tr>
                                    ...
                                    <th>Per 2 Jam 1x Seminggu (SIANG)</th>
                                    <th>Per 4 Jam 1x Seminggu (SIANG)</th>
                                    <th width="20%">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Rp {{ number_format($row->two_hours_afternoon, 0, ',', '.') }}</td>
                                    <td>Rp {{ number_format($row->four_hours_afternoon, 0, ',', '.') }}</td>
                                    <td>
                                    <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/badminton/member/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
