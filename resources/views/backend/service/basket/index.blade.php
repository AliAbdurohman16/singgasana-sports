                        ...
                        <table class="table categories-table" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/basket/daily/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <table class="table categories-table" id="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/basket/member/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
