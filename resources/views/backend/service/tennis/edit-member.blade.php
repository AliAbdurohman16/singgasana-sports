...
@section('title', 'Edit Data Tenis Member')
    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last mb-3">
          <h3>Edit Data</h3>
          <a href="{{ route('tennis') }}" class="btn btn-warning btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
          <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="{{ route('tennis') }}">Layanan</a>
              </li>
          ...
          <div class="col-lg-6">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('tennisMember.update', $member->id) }}" method="POST" class="form" data-parsley-validate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <label for="first-name-column">Per 3 Jam 1x Seminggu (SIANG)</label>
                                        <input type="text" name="three_hours_afternoon" id="three_hours_afternoon" class="form-control" value="{{ intval($member->three_hours_afternoon) }}"/>
                                    </div>
                                </div>
...
<script>
    ...
    new AutoNumeric('#three_hours_afternoon', {
        currencySymbol : 'Rp ',
        decimalCharacter : ',',
        digitGroupSeparator : '.',
        decimalPlaces: 0,
