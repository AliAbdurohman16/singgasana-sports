                        ...
                        <table class="table categories-table" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->category }}</td>
                                    <td>{{ $row->service->field_counts }} Meja</td>
                                    <td>Rp {{ number_format($row->price, 0, ',', '.') }}</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/table-tennis/daily/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <table class="table categories-table" id="table2">
                            <thead>
                                <tr>
                                    ...
                                    <th>Layanan</th>
                                    <th>Kategori</th>
                                    <th>Per 2 Jam 1x Seminggu</th>
                                    <th>Per 3 Jam 1x Seminggu</th>
                                    <th>Paket Suka - Suka 10 Jam</th>
                                    <th>Paket Suka - Suka 12 Jam</th>
                                    <th>Paket Suka - Suka 15 Jam</th>
                                    <th width="20%">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->service->name }}</td>
                                    <td>{{ $row->category }}</td>
                                    <td>Rp {{ number_format($row->two_hours, 0, ',', '.') }}</td>
                                    <td>Rp {{ number_format($row->three_hours, 0, ',', '.') }}</td>
                                    <td>Rp {{ number_format($row->ten_hours, 0, ',', '.') }}</td>
                                    <td>Rp {{ number_format($row->twelve_hours, 0, ',', '.') }}</td>
                                    <td>Rp {{ number_format($row->fifteen_hours, 0, ',', '.') }}</td>
                                    <td>
                                    <button class="btn btn-warning btn-sm mb-2" onclick="window.location='/service/table-tennis/member/{{ $row->id }}'"><i class="fas fa-edit"></i> Edit</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
