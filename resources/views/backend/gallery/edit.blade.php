          ...
          <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('galleries.update', $gallery->id) }}" method="POST"  class="form" enctype="multipart/form-data" data-parsley-validate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $gallery->title }}" placeholder="Judul" />
                                        @error('title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="5" placeholder="Deskripsi Singkat">{{ $gallery->short_description }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        @if ($gallery->foto_1)
                                                            <img src="{{ asset('storage/gallery/' . $gallery->foto_1) }}"
                                                                alt="image"class="img-thumbnail foto-1">
                                                        @else
                                                            <img src="{{ asset('backend/assets/images/logo/default.png') }}"
                                                                alt="image"class="img-thumbnail foto-1">
                                                        @endif
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" name="title_foto_1" class="form-control @error('title_foto_1') is-invalid @enderror" value="{{ $gallery->title_foto_1 }}" placeholder="Judul Foto 1"/>
                                                        @error('title_foto_1')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        @if ($gallery->foto_2)
                                                            <img src="{{ asset('storage/gallery/' . $gallery->foto_2) }}"
                                                                alt="image"class="img-thumbnail foto-2">
                                                        @else
                                                            <img src="{{ asset('backend/assets/images/logo/default.png') }}"
                                                                alt="image"class="img-thumbnail foto-2">
                                                        @endif
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" name="title_foto_2" class="form-control @error('title_foto_2') is-invalid @enderror" value="{{ $gallery->title_foto_1 }}" placeholder="Judul Foto 2"/>
                                                        @error('title_foto_2')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        @if ($gallery->foto_3)
                                                            <img src="{{ asset('storage/gallery/' . $gallery->foto_3) }}"
                                                                alt="image"class="img-thumbnail foto-3">
                                                        @else
                                                            <img src="{{ asset('backend/assets/images/logo/default.png') }}"
                                                                alt="image"class="img-thumbnail foto-3">
                                                        @endif
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" name="title_foto_3" class="form-control @error('title_foto_3') is-invalid @enderror" value="{{ $gallery->title_foto_1 }}" placeholder="Judul Foto 3"/>
                                                        @error('title_foto_3')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="summernote" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi">{{ $gallery->description }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
