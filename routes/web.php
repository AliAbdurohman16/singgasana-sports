...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('checkUserRole:admin,cashier,superadmin')->group(function () {
        ...
        Route::get('service/swimming-pool/school/create', [App\Http\Controllers\Backend\SwimmingPoolController::class, 'schoolCreate'])->name('swimmingPoolSchool.create');
        Route::post('service/swimming-pool/school/store', [App\Http\Controllers\Backend\SwimmingPoolController::class, 'schoolStore'])->name('swimmingPoolSchool.store');
        Route::get('service/swimming-pool/school/{id}', [App\Http\Controllers\Backend\SwimmingPoolController::class, 'schoolEdit'])->name('swimmingPoolSchool.edit');
        Route::put('service/swimming-pool/school/{id}', [App\Http\Controllers\Backend\SwimmingPoolController::class, 'schoolUpdate'])->name('swimmingPoolSchool.update');
        Route::delete('service/swimming-pool/school/{id}', [App\Http\Controllers\Backend\SwimmingPoolController::class, 'schoolDestroy'])->name('swimmingPoolSchool.destroy');
